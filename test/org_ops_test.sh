...
want 'import-otp-idp:' "import-otp-idp job missing"
want 'eiseron cf import-otp-idp' "import-otp-idp nao invoca o comando da automacao (eiseron cf import-otp-idp)"
want '$CI_PIPELINE_SOURCE == "web" && $CI_COMMIT_BRANCH == "production" && $IMPORT_OTP_IDP' "import-otp-idp nao e break-glass gateado por IMPORT_OTP_IDP (materializaria em pipeline normal e bloquearia ou mascararia falha)"
want '$IMPORT_OTP_IDP == null' "apply nao exclui pipelines de import-otp-idp (apply automatico rodaria e 409 antes do import manual)"
