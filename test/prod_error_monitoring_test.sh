...
want "kamal app exec --reuse --version" "superuser bootstrap must pass --version (no git repo in the deploy job to infer it)"
want "send_mail" "deploy does not smoke-test SMTP after bootstrapping the admin"
